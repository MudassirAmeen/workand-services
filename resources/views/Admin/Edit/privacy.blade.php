...
<script src="https://cdn.ckeditor.com/4.20.2/standard/ckeditor.js"></script>
    ...
    <div class="container-fluid card shadow py-3">
        <div class="card-header">
            <strong class="card-title">Edit Policys Form</strong>
        </div>
        <div class="card-body">
            <form action="{{ route('policy.update', ['policy' => $policy->id]) }}" class="row needs-validation" novalidate method="POST"
                ...
                <div class="col-12">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="simpleinput"
                            ...
                            value="@if (old('heading')) {{old('heading')}} @else {{$policy->heading}} @endif" name="heading">
                ...
                <div class="col-12">
                    <div class="form-group mb-3">
                        ...
                        <textarea
                            ...
                            rows="4" name="longdescription">@if (old('longdescription')) {{old('longdescription')}} @else {{$policy->longdescription}} @endif</textarea>
